...
export MYSQL_SERVER_ADDRESS="203.195.200.40:3306"
export MYSQL_USER=root
export MYSQL_PASSWORD=jZLfKEmkpCn53R8A
export SYSLOG_HOST=127.0.0.1
export APISIX_BASE_URL="http://api.coolask.cn/apisix/admin"
export APISIX_API_KEY="edd1c9f034335f136f87ad84b625c8f1"
export APISIX_DEBUG_URL="http://api.coolask.cn/"
